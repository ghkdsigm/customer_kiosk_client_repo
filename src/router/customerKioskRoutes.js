const customerKioskRoutes = [
	...
	},
	{
		...
		title: '구입차량검색',
		meta: { isMenu: true, layout: 'DefaultLayout', requireAuth: false, titleEN: 'CAR SEARCH' },
	},
	{
		path: '/customerkiosk/searchcarmanufacturer',
		name: 'searchcarmanufacturer',
		component: () => import('@/pages/customerkiosk/SearchCarmanufacturer.vue'),
		title: '제조사검색',
	...
	{
		path: '/customerkiosk/carsearchresults',
		name: 'carsearchresults',
		title: '차량검색결과',
		component: () => import('@/pages/customerkiosk/SearchCarResult.vue'),
		meta: { isMenu: true, layout: 'SideLayout', requireAuth: false, titleEN: 'CAR SEARCH' },
	},
	{
