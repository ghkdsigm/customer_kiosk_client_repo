	...
	<div class="wrapper h-screen">
			...
			<div class="flex flex-col justify-center py-[4vh]">
				...
				<div class="count text-center py-[1.2vh] px-[2vw]">
					<div class="flex flex-row justify-center items-center">
						<span class="mr-[2vw]">접수 대기 차량</span>
						<span class="num"
							><strong class="text-[#1bf9a2]">{{ waitingCarList.length }}</strong
							>대</span
						>
					</div>
				</div>
		...
		<div class="inner">
			<swiper
				...
				@reachEnd="slideEnd"
			>
				<swiper-slide v-for="(carInfo, idx) in waitingCarList" :key="idx"
					><PerformancesWaitingCard :carInfo="carInfo"
				/></swiper-slide>
			</swiper>
		</div>
	</div>
...
<script setup>
import PerformancesWaitingCard from '@/components/performances/waitingCard.vue'
...
const isLoop = !(props.waitingCarList.length < 11)
// console
onMounted(() => {
